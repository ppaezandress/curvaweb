...
// petición usa su propia sesión de Google, gc_refresh). Dos vistas: Lista (semana, con hero
// de lo que sigue) y Calendario (rejilla del mes). El diseño vive en <AgendaBoard/>.
export default function AgendaPage() {
  ...
  // Modo (persistido por dispositivo). Init perezoso lee localStorage: en SSR revienta y cae a
  // "lista" (try/catch); en cliente toma la preferencia. El toggle no se pinta hasta "ready",
