...
export const frentes: FrenteConsultoria[] = [
  {
    ...
    pilares: [
      {
        id: 'customers',
        titulo: 'Customers and Marketing',
      ...
      },
      {
        id: 'innovation',
        titulo: 'Innovation',
        subtitulo: 'Los sistemas de información que ordenan cómo trabajas por dentro. Un Information System es Odoo o Notion.',
        bullets: [
          'Information systems (Odoo, Notion)',
